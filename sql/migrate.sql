insert into ticket_type select id, name, price, ticket_limit AS total_limit from mabel.ticket_type;
...
insert into group_access_right (select group_access_right.id, group_id, ticket_type_id, null as allowance, launch_time as open_time, 1464735600 as close_time from mabel.group_access_right, mabel.event);
insert into payment_method select id, name, description from mabel.payment_method;
